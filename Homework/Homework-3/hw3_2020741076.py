...
print(moviereview)
s_words=wordcloud.STOPWORDS.union({'바로재생 버튼','기존','나무위키', '가능합니다','전 동영상','된다','무비클립,' '용의자중','6점', '지식iN', '블로그', '146명','선택해주세요','더보기','기본정보','29번째', '정보확인', '전 동영상', '버튼 문서', '내용', '나이별', '네이버TV NOW','그러던', '예', '관련문서','문서', '삭제됨', '평점', '동영상 바로재생','1점이 감소증가됨','내공', '저장소 네이버TV','관람등급을'})


image=wordcloud.WordCloud(font_path='C:/WINDOWS/FONTS/MALGUNSL.TTF',width=1000, height=700, stopwords=s_words).generate(moviereview)
